...
// Fetch feedback data
$sql = "SELECT id, course_unit, teacher, date, username FROM lecture_feedback";
...
<body>
    ...
    <table>
        <tr>
            <th>Username</th>
            <th>Lecture feedback Summury</tr>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                if (!in_array($row["username"], $displayedUsernames)) {
                    ...
                    echo "<td><a href='lecture_feedback_view.php?username=" . urlencode($row["username"]) . "'>View</a></td>";
                    echo "</tr>";
