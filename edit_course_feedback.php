...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert new entry into the edit_cfb table
    $insert_query = "INSERT INTO edit_cfb (Section, Category) VALUES ('$new_Section', '$new_Category')";
...
$query = "SELECT * FROM edit_cfb";
$result = mysqli_query($conn, $query);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Edit Course Feedback Form</title>
    <style>
        body {
...
<body>
    <h1>Edit Course Feedback Form</h1>
    ...
    <table border="1">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='c_edit.php?Section={$row['Section']}'>C_Edit</a> | <a href='c_delete.php?Section={$row['Section']}'>C_Delete</a></td>";
            echo "</tr>";
        }
        ?>
