...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['Section'])) {
        ...
        $query = "UPDATE edit_cfb SET Section='$new_section', Category='$category' WHERE Section='$section'";
        mysqli_query($conn, $query);
        mysqli_close($conn);
        // Redirect to course_manage.php after updating the entry
        ...
        $query = "INSERT INTO edit_cfb (Section, Category) VALUES ('$section', '$category')";
        mysqli_query($conn, $query);
        mysqli_close($conn);
        // Redirect to course_manage.php after adding new entry
        header("Location: edit_course_feedback.php");
        exit();
    }
}
...
if (isset($_GET['Section'])) {
    ...
    $query = "SELECT * FROM edit_cfb WHERE Section='$section'";
